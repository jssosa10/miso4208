...
it( 'lista de post y hacer click en uno', ()=> {
...
it( 'Despublicar post', ()=> {
  ...
  cy.get('.gh-publishmenu-footer').contains('Unpublish').click();
  cy.wait(2000);
...
it( 'Listado de tags y hacer click en un tag ', ()=> {
...
it( 'listado de paginas y hacer click en una pagina ', ()=> {
...
it( 'Publicar o Actualizar pagina ', ()=> {
  cy.get('.gh-btn span').contains(/Update|Publish/).click();
  cy.get('.gh-publishmenu-footer').contains(/Update|Publish/).click();
  cy.wait(3000);
  cy.get('.gh-btn span').contains('Update').click();
...
cy.get('input[name="name"]',{ timeout: 4000}).click().type("Pruebas E2E");
cy.get('[name="description"]',{ timeout: 4000}).click().type("Nueva prueba");
